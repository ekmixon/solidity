...
with open(f'{path}/../docs/bugs.json') as bugsFile:
    bugs = json.load(bugsFile)

versions = {}
with open(f'{path}/../Changelog.md') as changelog:
...
with open(f'{path}/../docs/bugs_by_version.json', 'r') as bugs_by_version:
    old_contents = bugs_by_version.read()
with open(f'{path}/../docs/bugs_by_version.json', 'w') as bugs_by_version:
